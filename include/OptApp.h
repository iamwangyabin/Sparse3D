...
#ifndef SPARSE3D_OPTAPP_H
#define SPARSE3D_OPTAPP_H
...
public:
    ...
    OptApp(int frame_num,
            std::string init_pose_file,
            std::string loop_file,
            std::string loop_info_file,
            std::string pose_file,
            std::string loop_remain_log_file,
            std::string info_remain_file,
            double weight=50.0):
