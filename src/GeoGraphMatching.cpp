...
GeoGraphMatching::GeoGraphMatching(pcl::PointCloud<pcl::PointXYZ>& keypoints1, pcl::PointCloud<pcl::PointXYZ>& keypoints2, const pcl::Correspondences& correspondence)
...
pcl::CorrespondencesPtr GeoGraphMatching::ComputeCorrespondenceByEigenVec(int best_num /* = 4 */)
{
...
Eigen::Matrix4f GeoGraphMatching::ComputeRigid(pcl::CorrespondencesConstPtr correspondence, const pcl::PointCloud<pcl::PointXYZ>& keypoints1, const pcl::PointCloud<pcl::PointXYZ>& keypoints2)
{
