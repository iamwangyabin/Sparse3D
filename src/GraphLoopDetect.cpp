...
bool GraphLoopDetect::Init(std::string &traj_file, int frame_num) {
...
void GraphLoopDetect::DetectLoop() {
    std::cout<<"Detecting...";
    struct state{
        bool in_stack;
        int level;
...
bool GraphLoopDetect::loop_eq(std::vector<int> &v1, std::vector<int> &v2) {
    if (v1.size() != v2.size())
        return false;
